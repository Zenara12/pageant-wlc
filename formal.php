...
//                print "$name : $value<br>";
    ...
    <body>
        <div id="main_container">
            <form name="form1" method="post" action="top5.php?judge=<?php echo $_GET['judge'] ?>" onsubmit="return validateForm()">
                <div id="header">
                    ...
                    <div id="menu">
                        ...
                        <li><a class="current">Formal Wear</a></li>
                ...
                <div class="green_box">
                    <div class="clock">
                        <img src="img/guy.png" alt="" title=""/>             
                    </div>
                    <div class="text_content">
                        <h1>Formal Wear</h1>
                        <p class="green">
                            NOTE: Please use the following as basis for rating the Fun Wear
                        </p>
